        ...
        <CarouselContent className="w-full gap-3">
          {slideItems?.map((slideItem, index) => {
            return (
              <CarouselItem
                key={index}
                className="basis-[409px] shrink-0  bg-[#050505] p-8  rounded-2xl me-5 group  border-2 border-primary text-white h-auto flex flex-col gap-4 items-stretch"
              >
                <Link
                ...
                <ul className="list-image-[url('/home/right-check.webp')] list-inside space-y-2 flex flex-col gap-4">
                ...
                <button className="px-12 py-2 w-fit cursor-pointer text-white border border-[#0DB981] border-t-transparent rounded-md flex items-center gap-5 hover:bg-[#0DB981] mt-auto">
